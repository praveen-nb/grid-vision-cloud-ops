...
-- Add sample customer incidents with correct status values
INSERT INTO customer_incidents (connection_id, incident_type, severity, status, description, customer_info, affected_customers, location) VALUES
  ...
  ('84885662-3cfc-4125-bfd9-0ff41825f748', 'voltage_sag', 'medium', 'open', 'Industrial customers reporting voltage quality issues', '{"primary_contact": "NYC Industrial Council", "phone": "+1-555-0456"}', 45, '{"lat": 40.6782, "lng": -73.9442, "area": "Industrial District, Queens"}'),
  ('84885662-3cfc-4125-bfd9-0ff41825f748', 'frequency_deviation', 'low', 'open', 'Minor frequency fluctuations detected', '{"primary_contact": "Grid Operations Center", "phone": "+1-555-0789"}', 0, '{"lat": 40.7128, "lng": -74.0060, "area": "Grid-wide monitoring"}');