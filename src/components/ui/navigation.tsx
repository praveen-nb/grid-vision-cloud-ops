...
const navigationItems = [
  ...
  { href: "/arcgis", label: "ArcGIS UI", shortLabel: "GIS" },
  { href: "/arcfm", label: "ArcFM UI", shortLabel: "FM" },
  { href: "/scada-control", label: "SCADA Control", shortLabel: "SCADA" },
  { href: "/outage-management", label: "Outage Management", shortLabel: "OMS" },
  { href: "/load-testing", label: "Load Testing", shortLabel: "Load" },
  { href: "/dr-latency", label: "DR/Latency Metrics", shortLabel: "Latency" },
  { href: "/hybrid-architecture", label: "Hybrid Architecture", shortLabel: "Hybrid" },
