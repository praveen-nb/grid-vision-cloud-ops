    ...
    Statement = [
      {
        ...
        Resource = "arn:aws:dynamodb:${data.aws_region.current.name}:*:table/${var.project_name}-*"
      }
    ]
  })
...
# VPC Endpoint for EC2 (Interface)
...
# VPC Endpoint for RDS (Interface)
...
# VPC Endpoint for Lambda (Interface)
...
# VPC Endpoint for SageMaker (Interface)
...
# VPC Endpoint for CloudWatch Monitoring (Interface)
...
# VPC Endpoint for Kinesis (Interface)
...
# VPC Flow Logs for Zero Trust monitoring
